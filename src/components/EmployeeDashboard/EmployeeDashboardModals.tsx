...
import type { EmployeeAvailability, ScheduleAssignment, EmployeeDataManager } from '../../lib/employeeDatabase';
...
interface ModalsProps {
  ...
  setIsTimeLogModalOpen: (v: boolean) => void;
