...
// Описание: Открывающие контейнеры страницы и кнопки переключения между вкладками.
// При изменении: заменять целиком при правке верхней панели или общих стилей.
// ============================================================
return (
  <div className="space-y-6">
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      ...
      {activeTab === 'shifts' && (
        // Содержимое вкладки перенесено в БЛОК 11
      )}
      
      {/* ===== ВКЛАДКА "ГЕНЕРАТОР ГРАФИКА" ===== */}
      {activeTab === 'schedule' && (
        // Содержимое вкладки перенесено в БЛОК 12
      )}
      
      {/* ===== ВКЛАДКА "РУЧНОЕ СОСТАВЛЕНИЕ СМЕНЫ" ===== */}
      {activeTab === 'manual' && (
        // Содержимое вкладки перенесено в БЛОК 13
      )}
      
      {/* ===== ВКЛАДКА "СОТРУДНИКИ" ===== */}
      {activeTab === 'employees' && (
        // Содержимое вкладки перенесено в БЛОК 14
      )}
      
      {/* ===== ВКЛАДКА "АТТРАКЦИОНЫ" ===== */}
      {activeTab === 'attractions' && (
        // Содержимое вкладки перенесено в БЛОК 15
      )}
